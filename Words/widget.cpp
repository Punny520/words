...
#define MY_APID 20220621001253710
#define MY_APID_KEY "DNQ2ydAXtyVEXnFaUuTT"
    ...
    ui(new Ui::Widget)
{
    ...
    connect(ui->but_back,&QPushButton::clicked,this,&Widget::back);
...
void Widget::back(){
    if(Global::getinstance()->getUser_account() == ""){
